...
const programItems = [
  ...
  "Material 100% imprimible y reutilizable",
  "Sistema gamificado de aventura",
...
const bonusItems = [
  "Actividades divertidas extra (Valor $19.99)",
  "Plan guiado de 30 días (Valor $29.99)",
  "Sistema de seguimiento (Valor $14.99)",
  ...
  <section className="py-16 md:py-24 bg-card">
    <div className="container mx-auto px-4">
      ...
      >
        ...
        <p className="text-muted-foreground">El precio subirá pronto - Aprovecha ahora</p>
      </motion.div>
      ...
      >
        <div className="bg-primary text-primary-foreground p-6 text-center">
          <h2 className="text-2xl md:text-3xl font-bold">Pequeños Exploradores de la Lectura</h2>
          <p className="text-primary-foreground/80 mt-1">Método Aventura Lectoescritora - Programa Completo</p>
        </div>

        <div className="p-8">
          <div className="flex justify-center mb-6">
            <img src={heroProduct} alt="Producto" className="w-40 rounded-xl shadow-lg" />
          </div>

          <h3 className="font-bold mb-4">Lo que recibirás:</h3>
          ...
          <h3 className="font-bold mb-4">Bonos GRATIS incluidos:</h3>
          ...
          <div className="text-center mb-6">
            <p className="text-sm text-muted-foreground mb-1">Valor total del programa + bonos:</p>
            <p className="text-2xl text-muted-foreground line-through opacity-60 font-bold">$124.95 USD</p>
            <p className="text-sm text-muted-foreground mt-3 mb-1">Precio especial de hoy:</p>
            <p className="text-5xl md:text-6xl font-black text-primary">$9.99</p>
            <p className="text-sm text-secondary font-bold mt-1">¡Ahorra más del 85%!</p>
          </div>
          ...
          <p className="text-center text-xs text-muted-foreground mt-4">
            Garantía de satisfacción de 7 días - 100% libre de riesgo
          </p>
        </div>
      </motion.div>
    </div>
