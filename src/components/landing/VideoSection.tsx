    ...
    <div className="container mx-auto px-4">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold mb-3">
          Esto no es teoría. Así funciona en la vida real.
        </h2>
        <p className="text-lg text-muted-foreground">
          Padres reales, usando el método con sus hijos — mira los resultados con tus propios ojos:
        </p>
      </motion.div>

      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        {videos.map((v, i) => (
          <VideoCard key={i} thumb={v.thumb} src={v.src} caption={v.caption} index={i} />
        ))}
      </div>
    </div>
  </section>
